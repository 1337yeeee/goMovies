...
-- Add a new producer to the table
INSERT INTO producers (id, name, img, description) VALUES (1, 'Steven Spielberg', 'https://m.media-amazon.com/images/M/MV5BMTY1NjAzNzE1MV5BMl5BanBnXkFtZTYwNTk0ODc0._V1_UX67_CR0,0,67,98_AL_.jpg', 'American film director, producer, and screenwriter');

-- Add another producer to the table
INSERT INTO producers (id, name, img, description) VALUES (2, 'Christopher Nolan', 'https://m.media-amazon.com/images/M/MV5BNjE3NDQyOTYyMV5BMl5BanBnXkFtZTcwODcyODU2Mw@@._V1_UY98_CR2,0,67,98_AL_.jpg', 'British film director, producer, and screenwriter');

INSERT INTO producers (id, name, img, description) VALUES (3, 'Quentin Tarantino', 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/Quentin_Tarantino_by_Gage_Skidmore.jpg/220px-Quentin_Tarantino_by_Gage_Skidmore.jpg', 'Quentin Jerome Tarantino is an American filmmaker and screenwriter, known for his nonlinear storytelling and stylized violence.');

-- Add a new movie to the table
INSERT INTO movies (name, year, country, description, img, producer_id) VALUES ('Jurassic Park', 1993, 'USA', 'A theme park suffers a major power breakdown that allows its cloned dinosaur exhibits to run amok', 'https://upload.wikimedia.org/wikipedia/en/e/e7/Jurassic_Park_poster.jpg', 1);

-- Add another movie to the table
INSERT INTO movies (name, year, country, description, img, producer_id) VALUES ('The Dark Knight', 2008, 'USA', 'Batman confronts the Joker, a master criminal who is terrorizing Gotham City', 'https://upload.wikimedia.org/wikipedia/en/1/1c/The_Dark_Knight_%282008_film%29.jpg', 2);
...
-- Add another movie to the table
INSERT INTO movies (name, year, country, description, img, producer_id) VALUES ('Forrest Gump', 1994, 'USA', 'A simple man with a low IQ embarks on an extraordinary journey through life, meeting historical figures along the way', 'https://upload.wikimedia.org/wikipedia/en/thumb/6/67/Forrest_Gump_poster.jpg/220px-Forrest_Gump_poster.jpg', 1);

-- Add another movie to the table
INSERT INTO movies (name, year, country, description, img, producer_id) VALUES ('Inception', 2010, 'USA', 'A thief who steals corporate secrets through the use of dream-sharing technology is given the inverse task of planting an idea into the mind of a C.E.O', 'https://upload.wikimedia.org/wikipedia/en/2/2e/Inception_%282010%29_theatrical_poster.jpg', 2);

-- Migration 1: Add the movie "Pulp Fiction"
INSERT INTO movies (name, year, country, description, img, producer_id)
